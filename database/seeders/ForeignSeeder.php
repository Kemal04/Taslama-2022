...
class ForeignSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $obj = new Foreign;
        $obj->country_id = '1';
        $obj->img = ('img/about/foreign/usa/usa-2.jpg');
        ...
        $obj = new Foreign;
        $obj->country_id = '2';
        $obj->img = ('img/about/foreign/england/england-2.jpg');
        ...
        $obj = new Foreign;
        $obj->country_id = '3';
        $obj->img = ('img/about/foreign/russia/russia-1.jpg');
        $obj->name = 'Iň çalt ösýän agac bambuk';
        ...
        $obj = new Foreign;
        $obj->country_id = '3';
        $obj->img = ('img/about/foreign/russia/russia-2.jpg');
        ...
        $obj = new Foreign;
        $obj->country_id = '4';
        $obj->img = ('img/about/foreign/turkish/turkish-1.jpg');
        ...
        $obj = new Foreign;
        $obj->country_id = '4';
        $obj->img = ('img/about/foreign/turkish/turkish-2.jpg');
        ...
        $obj = new Foreign;
        $obj->country_id = '5';
        $obj->img = ('img/about/foreign/china/china-1.jpg');
        $obj->name = 'Hytaý';
        $obj->title = 'Bu ýerde bar bolan senagat kärhanalarynyň agramly bölegi nebitgaz pudagynyň kärhanalary bolup durýar. Häzir 40 müňe golaý adam Tebigaty goramak jemgyýetiniň agzasy bolup, olaryň 20 müňe golaýy nebitgaz senagatynda zähmet çekýär.';
        $obj->save();
        ...
        $obj = new Foreign;
        $obj->country_id = '5';
        $obj->img = ('img/about/foreign/china/china-2.jpg');
        $obj->name = 'Hytaý';
        $obj->title = 'Bu ýerde bar bolan senagat kärhanalarynyň agramly bölegi nebitgaz pudagynyň kärhanalary bolup durýar. Häzir 40 müňe golaý adam Tebigaty goramak jemgyýetiniň agzasy bolup, olaryň 20 müňe golaýy nebitgaz senagatynda zähmet çekýär.';
        $obj->save();
    }
